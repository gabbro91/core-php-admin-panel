...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    error_log(print_r($data_to_store, true));
    ...
    if (!isset($data_to_store['disabilitato'])) {
        $data_to_store['disabilitato'] = 0; // Default value
    }

    // Reset db instance
    $db = getDbInstance();
    $last_id = $db->insert('acl_utenti', $data_to_store);
    if ($last_id) {
